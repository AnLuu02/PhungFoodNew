...
import { Card, Flex, Group, Table, Text, useMantineColorScheme } from '@mantine/core';
import { IconTrendingUp } from '@tabler/icons-react';

export default function UserChart() {
  const { colorScheme } = useMantineColorScheme();
  return (
    <Card w='100%' h='100%' shadow='sm' p='xl' withBorder>
      <Card.Section>
      ...
      <Card.Section my={14} h='100%'>
        <BarChart
          ...
          series={[
            {
              name: 'Smartphones',
              color: colorScheme === 'light' ? 'rgb(60, 60, 60)' : 'rgb(255,255,255)'
            }
          ]}
        />
      </Card.Section>
