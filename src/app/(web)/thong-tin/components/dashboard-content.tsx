...
export default function DashboardContent({
  ...
  switch (activeTab) {
    case 'user-info':
      TabPanelContent = <UserInfo userInfor={userInfor} />;
      break;
    case 'statistics':
      TabPanelContent = <UserStatistics />;
      break;
    case 'orders':
      TabPanelContent = <OrderList orders={orders} />;
      break;
    case 'promotions':
      TabPanelContent = <Promotions vouchers={vouchers} />;
      break;
    default:
  ...
  return (
    <Tabs
      ...
      classNames={{
        tab: `!border-[#e5e5e5] hover:bg-mainColor/10 data-[active=true]:bg-mainColor data-[active=true]:text-white dark:!border-dark-dimmed`,
