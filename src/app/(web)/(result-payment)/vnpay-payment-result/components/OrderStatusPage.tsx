...
export function OrderStatusPage({
  ...
  const [, , resetVoucher] = useLocalStorage<VoucherForUser>({ key: 'applied-vouchers', defaultValue: [] });
    ...
    >
      <Box className='space-y-6 p-8 text-center'>
        ...
        <Box className='space-y-2'>
          <Title order={2} className='font-quicksand text-2xl font-bold text-gray-900 dark:text-dark-text'>
            {displayTitle}
          </Title>
        ...
        <Box className='space-y-3 text-gray-600 dark:text-dark-text'>
          ...
          <Box className='space-y-2 rounded-lg bg-gray-50 p-3 dark:bg-dark-card'>
            {orderId ? (
              <Box>
                ...
                <Text size='sm' className='font-mono font-semibold text-gray-900 dark:text-dark-text'>
                  {orderId}
                </Text>
              </Box>
            ) : null}
            {amount ? (
              <Flex align={'center'} justify={'center'} gap={'xs'}>
                ...
                <Text size='lg' className='font-semibold text-gray-900 dark:text-dark-text'>
