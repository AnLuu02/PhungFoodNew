...
interface OrderStatusPageProps {
  ...
  orderId?: string;
  amount?: number;
  status: 'success' | 'processing' | 'delivered' | 'cancelled' | 'error' | 'payment_failed';
  customTitle?: string;
      ...
      <Box className='space-y-6 p-8 text-center'>
        ...
        <Box className='flex justify-center'>
          <Flex
            align={'center'}
            gap={'xs'}
            className={`${currentStatus.color} rounded-full px-4 py-2 text-sm font-semibold text-white`}
          >
