  ...
  return (
    <Center className='min-h-[calc(100dvh-var(--header-height,0px))] w-full bg-white px-5 py-10'>
      <Stack align='center' gap={0} className='w-full max-w-5xl text-center'>
        <Image
          src='/images/jpg/comming-soon-illustration.jpg'
          alt='Coming Soon - Đang phát triển'
          fit='contain'
          loading='eager'
          fetchPriority='high'
        ...
        <Text className='mt-4 max-w-[620px] px-2 text-sm leading-7 text-[#56536f] sm:text-base sm:leading-8'>
          Trang này đang được xây dựng và sẽ sớm ra mắt.
          <br className='hidden sm:block' />
          Vui lòng quay lại sau hoặc liên hệ với chúng tôi nếu cần hỗ trợ.
        </Text>
        ...
        <div className='mt-8 flex flex-col items-center gap-3 sm:flex-row'>
          <Button
            size='lg'
            radius='xl'
            leftSection={<IconBellRinging size={20} stroke={2} />}
