        ...
        <Table striped highlightOnHover withTableBorder withColumnBorders className='min-w-full'>
          <TableThead>
            <TableTr className='bg-gray-50'>
              <TableTh className='font-semibold text-gray-700 dark:text-dark-text'>Sản phẩm</TableTh>
              <TableTh className='font-semibold text-gray-700 dark:text-dark-text'>Danh mục</TableTh>
              <TableTh className='font-semibold text-gray-700 dark:text-dark-text'>Giá</TableTh>
              <TableTh className='font-semibold text-gray-700 dark:text-dark-text'>Số lượng đặt</TableTh>
            </TableTr>
          </TableThead>
          <TableTbody>
              ...
              <TableTr key={index} className='transition-colors hover:bg-mainColor/10'>
                <TableTd>
                  <Group gap='sm'>
                    ...
                    <Text className='font-medium text-gray-800 dark:text-dark-text'>{item.name}</Text>
                  </Group>
                </TableTd>
                <TableTd>
                  <Text className='inline-block rounded-full bg-gray-100 px-2 py-1 text-xs text-gray-600 dark:text-dark-text'>
                    {item.category}
                  </Text>
                </TableTd>
